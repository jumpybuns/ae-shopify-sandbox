import{b as $}from"./chunk-WW7TENNA.js";import{a as F}from"./chunk-5C7HDTHJ.js";import{R as _}from"./chunk-6EZ7JWBK.js";import{d as T}from"./chunk-WRRUFK4Y.js";import{d}from"./chunk-WKBVT5WG.js";import{Fb as h,Hb as g,Lb as P,aa as E}from"./chunk-DONEJHDG.js";import{c as O}from"./chunk-KKUDXLK2.js";import{a as b}from"./chunk-NNOSZ447.js";import{r as I}from"./chunk-T6CC5WUU.js";import{e as S,g as w}from"./chunk-VKWPEFWQ.js";w();var u=S(I()),p=class extends u.Command{static descriptionWithoutMarkdown(){return(this.descriptionWithMarkdown??"").replace(/(\[)(.*?)(])(\()(.*?)(\))/gm,'"$2" ($5)')}static analyticsNameOverride(){}static analyticsStopCommand(){}async catch(n){n.skipOclifErrorHandling=!0;let{errorHandler:r}=await import("./error-handler-SW2ALZ5Z.js");return await r(n,this.config),u.Errors.handle(n)}async init(){if(this.exitWithTimestampWhenEnvVariablePresent(),$(this.id??""),!O()){let{registerCleanBugsnagErrorsFromWithinPlugins:r}=await import("./error-handler-SW2ALZ5Z.js");await r(this.config)}await x(this.config),this.showNpmFlagWarning();let{showNotificationsIfNeeded:n}=await import("./notifications-system-DP443VTE.js");return await n(),super.init()}showNpmFlagWarning(){let n=this.constructor;Object.keys(n.flags||{}).map(t=>`npm_config_${E(t).replace(/^no_/,"")}`).some(t=>process.env[t]!==void 0)&&import("./ui-QOGKADWB.js").then(({renderWarning:t})=>{t({body:["NPM scripts require an extra",{command:"--"},"separator to pass the flags. Example:",{command:"npm run dev -- --reset"}]})})}exitWithTimestampWhenEnvVariablePresent(){b(process.env.SHOPIFY_CLI_ENV_STARTUP_PERFORMANCE_RUN)&&(P(`
